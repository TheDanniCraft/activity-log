...
2. 🚀 Created a new tag `v1.0.0` in [TheDanniCraft/activity-log](https://github.com/TheDanniCraft/activity-log)
...
9. 🚀 Created a new tag `v1` in [TheDanniCraft/activity-log](https://github.com/TheDanniCraft/activity-log)
