...
1. 🚀 Committed to [TheDanniCraft/activity-log](https://github.com/TheDanniCraft/activity-log/commit/c93168506585112f3c571af11eaea2a5ed736ba3)
2. 🔥 Deleted a branch `renovate/npm/http-client` in a private repo
3. 🚀 Committed to a private repo
4. 🚀 Committed to a private repo
5. 🚀 Published release [`v1.4.4`](https://github.com/TheDanniCraft/clipify/releases/tag/v1.4.4) in [TheDanniCraft/clipify](https://github.com/TheDanniCraft/clipify)
6. 🔥 Deleted a branch `patch-v1.4.4` in [TheDanniCraft/clipify](https://github.com/TheDanniCraft/clipify)
7. 🔀 Merged [PR #89](https://github.com/TheDanniCraft/clipify/pull/89) in [TheDanniCraft/clipify](https://github.com/TheDanniCraft/clipify)
8. 🚀 Committed to [TheDanniCraft/clipify](https://github.com/TheDanniCraft/clipify/commit/b876a5b3bd9bf3f52b2dd1b396a9c42edb96a403)
9. 🔀 Opened [PR #89](https://github.com/TheDanniCraft/clipify/pull/89) in [TheDanniCraft/clipify](https://github.com/TheDanniCraft/clipify)
10. 🚀 Committed to [TheDanniCraft/clipify](https://github.com/TheDanniCraft/clipify/commit/b83de79ba8f358ea78a48ce16f30115bd36e322c)
